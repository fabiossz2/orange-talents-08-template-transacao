package br.com.zupacademy.fabio.transacao.kafka.configuration;

import br.com.zupacademy.fabio.transacao.transacoescartao.TransacaoForm;
...
public class KafkaConsumerConfiguration {
    ...
    public ConsumerFactory<String, TransacaoForm> transactionConsumerFactory() {
        ...
        final JsonDeserializer<TransacaoForm> jsonDeserializer = new JsonDeserializer<>(TransacaoForm.class, false);
        return new DefaultKafkaConsumerFactory<>(consumerConfigurations(), stringDeserializer, jsonDeserializer);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TransacaoForm> kafkaListenerContainerFactory() {
        final ConcurrentKafkaListenerContainerFactory<String, TransacaoForm> factory = new ConcurrentKafkaListenerContainerFactory<>();
